...
Statistical processing of COVID-19 data using Apache Beam for Google Cloud Dataflow in Python. Project for the exam of Cloud Systems and Applications (2019-20), course *Magistrale di Ingegneria Informatica at the Dipartimento di Ingegneria Enzo Ferrari*. 
